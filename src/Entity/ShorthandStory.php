...
class ShorthandStory extends RevisionableContentEntityBase implements ShorthandStoryInterface {
  ...
  public function preSave(EntityStorageInterface $storage) {
    ...
    if ($this->isNew()) {
      $file = \Drupal::service('shorthand.api')->getStory($this->getShorthandStoryId());
      ...
      $head = mb_convert_encoding(
        file_get_contents($destination_path . '/component_head.html'),
        "HTML-ENTITIES",
        "UTF-8"
      );
      ...
      $body = mb_convert_encoding(
        file_get_contents($destination_path . '/component_article.html'),
        "HTML-ENTITIES",
        "UTF-8"
      );
